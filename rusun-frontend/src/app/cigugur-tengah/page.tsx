...
import {
  ...
  ShieldCheck, ShowerHead, Car, Tag, ListTodo
} from "lucide-react";
...
export default function CigugurTengahPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-300 transition-colors duration-300 font-sans">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-slate-200 dark:border-white/5 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium">
            <ArrowLeft className="w-5 h-5" /> Kembali
          </Link>
          <div className="flex items-center gap-3">
            <span className="font-bold text-lg tracking-tight text-slate-900 dark:text-white">Rusunawa Cimahi</span>
          </div>
      ...
      <section className="py-20 relative overflow-hidden flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 leading-relaxed mb-12 max-w-2xl mx-auto">
            Hunian vertikal yang nyaman dan strategis di kawasan Cigugur Tengah. Ideal untuk keluarga kecil yang mendambakan lingkungan bersih, aman, dan tertata dengan baik.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="bg-white dark:bg-white/5 p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-center"><p className="text-sm text-slate-500 mb-1">Tipe Hunian</p><p className="font-bold text-slate-900 dark:text-white">Unit Type 21</p></div>
            </div>
            <div className="bg-white dark:bg-white/5 p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-center"><p className="text-sm text-slate-500 mb-1">Kapasitas</p><p className="font-bold text-slate-900 dark:text-white">192 Total Unit</p></div>
            </div>
            <div className="bg-white dark:bg-white/5 p-6 rounded-3xl border border-slate-200 dark:border-white/10 flex flex-col items-center gap-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-center"><p className="text-sm text-slate-500 mb-1">Lokasi</p><p className="font-bold text-slate-900 dark:text-white">Cimahi Tengah</p></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-slate-50 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <FloorPlan locationName="Rusunawa Cigugur Tengah" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-3xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
              ...
              <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Keamanan 24 Jam</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">CCTV dan petugas security berjaga di setiap area untuk keamanan warga.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-3xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/40 rounded-full flex items-center justify-center mb-6 text-blue-600 dark:text-blue-400">
                <Car className="w-8 h-8" />
              </div>
              <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Area Parkir Luas</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Tersedia parkir motor yang tertata dan ruang publik yang leluasa.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-3xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/40 rounded-full flex items-center justify-center mb-6 text-blue-600 dark:text-blue-400">
                <ShowerHead className="w-8 h-8" />
              </div>
              <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Air Bersih (PDAM)</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Distribusi air bersih yang lancar 24 jam untuk kebutuhan sehari-hari.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-3xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/40 rounded-full flex items-center justify-center mb-6 text-blue-600 dark:text-blue-400">
                <Building2 className="w-8 h-8" />
              </div>
              <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Aula Bersama</h4>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">Fasilitas ruang serbaguna untuk kegiatan sosial dan pertemuan warga.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-slate-700 dark:text-slate-300 space-y-3 font-medium">
                <p className="text-lg font-bold text-slate-900 dark:text-white mb-4">Type 21</p>
                <p>Lantai I (Difabel) : Rp. 448.000</p>
                <p>Lantai I (Non Difabel) : Rp. 480.000</p>
                <p>Lantai II : Rp. 440.000</p>
                <p>Lantai III : Rp. 410.000</p>
                <p>Lantai IV : Rp. 380.000</p>
                <p>Lantai V : Rp. 320.000</p>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-slate-700 dark:text-slate-300 leading-relaxed text-center space-y-6">
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-white/10">
                  <p className="font-bold text-slate-900 dark:text-white mb-2">Type 21</p>
                  <p>
      ...
      <section className="py-20 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="w-full h-[450px] rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-white/10">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.916173062024!2d107.5458034!3d-6.9006095!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e4c053b2ce21%3A0xc00234a413d52dd7!2sRusunawa%20Cigugur%20Tengah!5e0!3m2!1sid!2sid!4v1709715111111!5m2!1sid!2sid" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 

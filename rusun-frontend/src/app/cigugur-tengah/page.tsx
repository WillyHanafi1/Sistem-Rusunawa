...
import { Building2, MapPin, Layers, Users, ShieldCheck, ShowerHead, Car, Tag, ListTodo } from "lucide-react";
...
export default function CigugurTengahPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-300 transition-colors duration-300 font-sans">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/10 flex flex-col items-center gap-3 shadow-xl hover:bg-slate-900/60 transition-all group">
              ...
              <div className="text-center"><p className="text-sm text-slate-400 mb-1">Tipe Hunian</p><p className="font-bold text-white">Unit Type 21</p></div>
            </div>
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/10 flex flex-col items-center gap-3 shadow-xl hover:bg-slate-900/60 transition-all group">
              ...
              <div className="text-center"><p className="text-sm text-slate-400 mb-1">Kapasitas</p><p className="font-bold text-white">192 Total Unit</p></div>
            </div>
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/10 flex flex-col items-center gap-3 shadow-xl hover:bg-slate-900/60 transition-all group">
              ...
              <div className="text-center"><p className="text-sm text-slate-400 mb-1">Lokasi</p><p className="font-bold text-white">Cimahi Tengah</p></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="text-slate-700 dark:text-slate-300 space-y-3 font-medium">
                ...
                <p>Lantai I : Rp. 365.000</p>
                <p>Lantai II : Rp. 350.000</p>
                <p>Lantai III : Rp. 335.000</p>
                <p>Lantai IV : Rp. 320.000</p>
      ...
      <section className="py-20 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="w-full h-[450px] rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-white/10">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9527911861505!2d107.5570331!3d-6.8962503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e531291286d3%3A0x463ca00467478b62!2sUPTD%20Rusunawa%20Kota%20Cimahi!5e0!3m2!1sen!2sid!4v1776089079076!5m2!1sen!2sid"
              width="100%"
              height="100%"
              style={{ border: 0 }}
      ...
      <ApplicationForm 
        targetRusunawa="Cigugur Tengah" 
        locationDisplayName="Rusunawa Cigugur Tengah" 
      />
